...
public class AgencyAdminAgentsFragment extends Fragment {
    ...
    public static AgencyAdminAgentsFragment newInstance(String userId,boolean showAppBarIfFragmentClosed) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        agencyAdminAgentCardAdapter = new AgencyAdminAgentCardAdapter(agentList, new AgencyAdminAgentCardAdapter.OnJobClickListener() {
            ...
            public void onManageAgent(String userId) {
                ...
                getChildFragmentManager().beginTransaction().setCustomAnimations(R.anim.slide_right_to_left, R.anim.exit_right_to_left, R.anim.slide_left_to_right, R.anim.exit_left_to_right).replace(R.id.flAgencyAdminAgents, AgentJobsFragment.newInstance(userId,showAppBarIfFragmentClosed)).addToBackStack(null).commit();
            ...
            public void onEditAgent(String userId) {
                ...
                getChildFragmentManager().beginTransaction().setCustomAnimations(R.anim.slide_right_to_left, R.anim.exit_right_to_left, R.anim.slide_left_to_right, R.anim.exit_left_to_right).replace(R.id.flAgencyAdminAgents, EditProfileFragment.newInstance(userId)).addToBackStack(null).commit();
