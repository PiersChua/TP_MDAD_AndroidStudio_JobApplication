 ...
 * Use the {@link EditAgentProfileFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class EditAgentProfileFragment extends Fragment {
    ...
    public EditAgentProfileFragment() {
     ...
     * @return A new instance of fragment EditAgentProfileFragment.
     */
    public static EditAgentProfileFragment newInstance(User user) {
        EditAgentProfileFragment fragment = new EditAgentProfileFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_edit_agent_profile, container, false);
    }
    @Override
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        topAppBar = view.findViewById(R.id.topAppBarEditAgentProfile);
        btnEditProfile = view.findViewById(R.id.btnEditAgentProfile);
