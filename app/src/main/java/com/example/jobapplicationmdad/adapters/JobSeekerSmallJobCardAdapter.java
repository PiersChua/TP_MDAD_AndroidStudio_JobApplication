...
public class JobSeekerSmallJobCardAdapter extends RecyclerView.Adapter<JobSeekerSmallJobCardAdapter.ViewHolder> {
     ...
     */
    public JobSeekerSmallJobCardAdapter(List<Job> dataSet, OnJobClickListener listener) {
        jobs = dataSet;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView tvSmallJobCardAgencyName;
        ...
        public ViewHolder(View view, OnJobClickListener listener) {
            ...
            tvSmallJobCardAgencyName = view.findViewById(R.id.tvSmallJobCardAgencyName);
        ...
        public void bind(Job job) {
            ...
            tvSmallJobCardAgencyName.setText(job.getUser().getAgency().getName());
